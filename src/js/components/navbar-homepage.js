window.navbar = {
    ...
    set isOpen(input) {
        ...
        if (indexPageHeroSection)
            if (input) indexPageHeroSection.classList.add("-z-10");
            else indexPageHeroSection.classList.remove("-z-10");
    ...
    init() {
        // homepage mode
        function homeMode() {
            if (["lg", "xl"].includes(currentBrackPoint()) === false)
                return;
            document
        ...
        function traverse(el, index = 0) {
            ...
            t.name = name
                ? name.innerHTML.replace(/\s+/g, " ").trim()
                : "ROOT";
        ...
        function placeNavbarFixed() {
            homeMode();
            document
                .querySelector("#navigation-placeholder")
                .appendChild(document.querySelector("#navigation"));
            document.querySelector(
        ...
        function placeNavbarSticky() {
            ...
            document
                .querySelector("#navigation-sticky-placeholder")
                .appendChild(document.querySelector("#navigation"));
            document.querySelector(
                "#navigation-sticky-placeholder"
